...
public class Instruction extends GameStage {
	public final Image about= new Image("images/instructionPage.jpg", GameStage.WINDOW_WIDTH,GameStage.WINDOW_HEIGHT,false,false);
	public Instruction() {
		this.root = new Group();
